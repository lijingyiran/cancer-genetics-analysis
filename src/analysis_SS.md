...
![](Simran-_files/figure-markdown_strict/fig6-1.png) \#Density Plot
...
![](Simran-_files/figure-markdown_strict/fig11-7.png)

    #Multiple PCA plots 
    ggarrange(a, b, c, ncol = 2, nrow = 2)

![](Simran-_files/figure-markdown_strict/fig12-1.png)

    ggarrange(d,e,f,g, ncol = 2, nrow = 2)

![](Simran-_files/figure-markdown_strict/fig12-2.png)
